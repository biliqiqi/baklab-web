  ...
  (
    ...
    const setOpenMobile = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // Check preventMobileCloseUntil before allowing close
        if (!openState && preventMobileCloseUntil > Date.now()) {
          return
        }
      ...
      [setOpenMobileProp, openMobile, statePersistKey, preventMobileCloseUntil]
    )
      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              'group/sidebar-wrapper flex items-start w-full has-[[data-variant=inset]]:bg-sidebar',
              className
            )}
            ref={ref}
            {...props}
...
>(
  (
    ...
    const handleOpenMobileChange = React.useCallback(
      ...
      [setOpenMobile, preventMobileCloseUntil]
    )
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'duration-200 flex h-8 px-2.5 shrink-0 items-center rounded-md mb-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'data-[active=true]:bg-primary/90 data-[active=true]:text-primary-foreground',
        size === 'sm' && 'text-xs',
        size === 'md' && 'text-sm',
        'group-data-[collapsible=icon]:hidden',
        className
